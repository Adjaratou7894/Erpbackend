...
public class TirageController {
    ...
    @PutMapping("/valider/{libelleTirage}")
    public ReponseMessage validerTirage(@PathVariable String libelleTirage){

        return tirageService.validerTirageTirage(libelleTirage);
    }
